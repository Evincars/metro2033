...
Name origin: по находящемуся неподалёку парку культуры и отдыха «Фили» (который находится в 400 метрах, примерно на таком же расстоянии и от соседней станции — Багратионовской).
...
Станция построена по типовому проекту с островной платформой, общему с обеими соседними станциями. Над платформой устроен навес, но зона над путями
      ...
      краской. Платформы были покрыты асфальтом. The columns are clad in серым marble.
