...
brief: "Mayakovskaya is a deep-level column three-vault station."
---

Mayakovskaya is a deep-level column three-vault station.
...
Станция Mayakovskaya является объектом культурного наследия города Москвы. В 1939 году на Всемирной выставке в Нью-Йорке проект станции получил гран-при.
      Станция построена по уникальному проекту: это первая в мире колонная станция глубокого заложения со стальными колоннами.
