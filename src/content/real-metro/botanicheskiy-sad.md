...
Колонны и путевые стены облицованы желтовато-white marble. The floor is laid with красновато-grey granite с квадратными inlays из чёрного лабрадорита
      по оси станции и продольными stripes из белого мрамора вдоль краёв платформы. Нетипичный элемент оформления типовой станции — подвесной потолок
      из анодированного алюминия золотистого цвета, состоящий из квадратных ячеистых секций. В ячейках потолка размещены светильники.
