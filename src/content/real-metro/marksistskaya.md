...
Name origin: по улице, на которой находится выход (название улицы — без исторических территориальных корней; дореволюционное её название — Пустая).

Дата открытия — 30 декабря 1979.

Архитекторы станции — Н. А. Алёшина, В. С. Волович, Н. К. Самойлова, Р. П. Ткачёва.

The track walls are clad in золотисто-розовым marble «газган» с чёрным гранитным цоколем. The columns are clad in розовым marble «буровщина». The floor is laid with
      grey granite с красными inlays в виде восьмиконечных звёзд. Центральный зал станции освещается необычными люстрами, выполненными в виде спиралей,
