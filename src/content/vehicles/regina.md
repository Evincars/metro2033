...
brief: "Regina is a special railcar built by Andrew the Blacksmith that appears in the Metro: Last Light level of the same name."
wiki: Regina_(Vehicle)
appearances: Metro 2033, Metro: Last Light, Metro Exodus
---

**Regina** is a special [railcar](https://metrovideogame.fandom.com/wiki/railcar) built by [Andrew the Blacksmith](https://metrovideogame.fandom.com/wiki/Andrew) that appears in the *Metro: Last Light* [level](https://metrovideogame.fandom.com/wiki/Levels) [of the same name](https://metrovideogame.fandom.com/wiki/Regina_(Metro_Last_Light_Level)).

## Overview

The Regina was built for the sole purpose of ferrying refugees from the [Reich](https://metrovideogame.fandom.com/wiki/Fourth_Reich) and [Red Line](https://metrovideogame.fandom.com/wiki/Red_Line) to safety in [Hanza](https://metrovideogame.fandom.com/wiki/Hanza) or neutral stations. The vehicle is fairly well armoured, more so than a railbike or even a turret car but not designed for combat, carrying no weapons of any kind.

The main dangers it faces are attacks by mutants, the most numerous of which, [spiderbug](https://metrovideogame.fandom.com/wiki/spiderbug)s, are infesting the tunnels beyond Andrew's home. To ward them off, Regina is outfitted with powerful headlights and light bulbs, creating a wall of light repelling any spiderbug caught within. While the lights don't ward off other mutants, it does make the gloomy tunnels less ominous. Andrew loans [Artyom](https://metrovideogame.fandom.com/wiki/Artyom) Regina so he can travel to [Venice](https://metrovideogame.fandom.com/wiki/Venice_(Location)), telling him to find Woodpecker who can help him. Before reaching Venice, however, Regina is derailed after colliding with an wooden barrier and forced to be abandoned in [Bandits](https://metrovideogame.fandom.com/wiki/Bandits_(Metro_Last_Light_Level)).
...
- In *[Metro 2033 Redux](https://metrovideogame.fandom.com/wiki/Metro_2033_Redux)*, the design plan for Regina is seen hanging on a wall in Andrew's room at the [armory](https://metrovideogame.fandom.com/wiki/Armory_(Level)).
