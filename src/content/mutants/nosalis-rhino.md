...
- When the player first encounters the Rhino, a rare glitch will sometimes occur after falling off the bridge where it will stand in the arena and not move, but will look at the player if they get close enough. The only way to counteract this glitch is to restart the system and then restart the level.
