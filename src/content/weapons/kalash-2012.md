...
brief: "The Kalash 2012, or AK-2012, is a fictional next-generation Kalashnikov bullpup assault rifle that had been introduce..."
wiki: Kalash_2012
...
It can accept [reflex, IRNV, and 2x optical sights](https://metrovideogame.fandom.com/wiki/Attachments) making it useful for both close and long range combat. It can accept silencer like VSK-94 and AK-74M.
...
- The weapon lacks a charging handle necessary to operate the gun, chamber rounds, and clear gun jams. The weapon likely has ways of chambering a new round after a fresh magazine, most likely having an automatic bolt-release. However, this does not explain the lack of a charging handle, which is an absolute necessity.
- The weapon does not seem to have a means to rotate the cartridges into firing position, as they all sit 90 degrees to the chamber. The P90 solved this by having said mechanism in the magazine, rotating each cartridge and feeding it into the gun as it fires. However, 2012 magazines do not seem to have a similar mechanism.
  - Furthermore, 5.45x39mm ammunition is a tapered cartridge (and quite substantially), unlike the 5.7x28mm which the P90 chambers. Stacking cartridges side by side would very soon cause the column form a crescent, thus making a P90 style magazine for 5.45mm as seen on the Kalash 2012 geometrically impossible.
- The weapon has no room for the bolt and buffer spring (located in the stock/rear-receiver) needed to function.
  - It could be using a vertically moving bolt like the [TKB-022PM](https://metrovideogame.fandom.com/wiki/wikipedia:TKB-022PM), another Russian bullpup assault rifle. There were concerns about the weapon's displaced centre of gravity as a result of the magazine location, which is a problem the Kalash 2012 would solve with its top-mounted magazine.
- The weapon could not mechanically support an AK style gas operating system as it appears to in the current design.
...
- The weapon appears to be based heavily on the OTS-14 Groza, but with a magazine similar to that of the FN P90, and firing the 5.45x39mm ammo used by weapons like the AN-94, AK-74M, and RPK-74, rather than the 7.62x39mm or 9x39mm rounds that the OTS-14 actually uses.
- The silencer that a Kalash 2012 uses doesn't cover the muzzle break. In real life, this would negate the effect of the silencer.
...
- Seeing as the weapon is referred to as "**Kalash**", it's possible that it was engineered by Mikhail Kalashikov, creator of the famous AK-47.
  - This gun is not to be confused with the real-life AK-12, which is a substantially different weapon from the Kalash 2012 seen in Metro. The former is a modernised AK-74M, with Picatinny rails, an ambidextrous charging handle, and chambering for all modern calibers; it was designed in 2011 and entered production in 2018, long after the game was being made.
- During the **Enlightened** [ending](https://metrovideogame.fandom.com/wiki/Endings), the scoped and suppressed variant is seen on [Artyom](https://metrovideogame.fandom.com/wiki/Artyom)'s back, as opposed to the [VSV](https://metrovideogame.fandom.com/wiki/VSV) seen in the **Ranger** ending.
- In *Metro 2033*, Artyom never uses a Kalash 2012 against human enemies, as during the final portion of the game where the weapon is available Artyom will only encounter mutants. This is changed in Redux, where it can be acquired and used in [Black Station](https://metrovideogame.fandom.com/wiki/Black_Station_(Metro_2033_Level)) (see locations for more details).
- The Kalash 2012 is the favoured weapon of the [Rangers](https://metrovideogame.fandom.com/wiki/Spartan_Rangers) in *Metro 2033* and it's only seen in use by them. Only Miller and Artyom, if the player chooses to do so, are seen using a customised Kalash 2012 though.
- In Last Light, the Kalash is only seen in the hands of Red Line elite forces, a Hanza soldier in "[Quarantine](https://metrovideogame.fandom.com/wiki/Quarantine_(Metro_Last_Light_Level))", and Reich officers during the "[Anna](https://metrovideogame.fandom.com/wiki/Anna_(Level))" chapter. The Kalash 2012 is available in the Ranger arsenal, but few of them use it.
- The idle animation for the 2012 changes between 2033 and Last Light;
...
- Artyom never actually uses the foregrip of the Kalash 2012 in *Metro: Last Light*, instead holding it like a standard Kalash or Bastard. In the original *Metro 2033* he does, however this was later changed in *Metro 2033 Redux*.
