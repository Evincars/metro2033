...
brief: "The Helsing (Russian: Хельсинг) is a semi-automatic, revolving octuple-barreled, multi-stroke, bolt-firing air gun an..."
wiki: Helsing
...
Unlike the Tihar's [ball bearings](https://metrovideogame.fandom.com/wiki/ball_bearings), the Helsing fires [arrows](https://metrovideogame.fandom.com/wiki/arrows), which have much more consistent damage than the ball bearings, especially when used for stealth attacks (where the arrows are often lethal). These arrows are reusable provided [Artyom](https://metrovideogame.fandom.com/wiki/Artyom) can reach them, making them one of the best ammo types for the cost. The Helsing can equip a [scope](https://metrovideogame.fandom.com/wiki/Attachments) like the Tihar, but this scope is the PK-AV Scope used by the [Kalash](https://metrovideogame.fandom.com/wiki/Kalash_(AK-74M)), not the open-eye optical scope of the Tihar. This can aid mid-range accuracy, and makes the Helsing quite lethal in skilled hands. Over-pressurized, the Helsing's arrows possess even heavier damage than the Tihar's bullets, though the difference is not quite overwhelming.
...
- Artyom can take advantage of an ammo stash located next to his seat during the cart ride of the "[Depot](https://metrovideogame.fandom.com/wiki/Depot_(Metro_2033_Level))" level to increase their arrow supply.
- It can be still be salvaged from [Hole Station](https://metrovideogame.fandom.com/wiki/Hole_Station) during the "[Defense](https://metrovideogame.fandom.com/wiki/Defense_(Metro_2033_Level))" level in one of the offices upstairs (the one that is surrounded by metal bars). It can be found next to the locked safe.
...
- Next to a corpse by a pillar in "[The Crossing](https://metrovideogame.fandom.com/wiki/The_Crossing_(Metro_Last_Light_Level))" (with laser sight, reflex sight).
...
- There are eighteen **Sniper Stocks, Grip and Forend** for the Helsing that can be found in the Taiga:
  ...
  - Left behind after the [Master of the Forest](https://metrovideogame.fandom.com/wiki/Master_of_the_Forest) attacks the two Pirates and two Pioneers while Artyom is stuck in the Net. Attached to a Helsing.
...
- In the twelve-minute E3 preview of *[Metro: Last Light](https://metrovideogame.fandom.com/wiki/Metro:_Last_Light)*, the Helsing is seen with a reflex sight attached to it.
