...
brief: "The VSV, also known as VSK-94 (Войсковой Снайперский Комплекс or Military Sniper Complex), was a fully-automatic snip..."
wiki: VSV
...
VSV is one of the weapons in the Metro that predates the war and it's highly prized by many survivors. Since the VSK-94 is a primary weapon it can use both dirty and MGR [5.45x39mm](https://metrovideogame.fandom.com/wiki/5.45x39mm) cartridges.

The very first VSV in the game is available for purchase in the [Armory](https://metrovideogame.fandom.com/wiki/Armory_(Level)) in both scoped and unscoped variants. Three unscoped versions can be found at the [Black Station](https://metrovideogame.fandom.com/wiki/Black_Station_(Level)) for free, one of which is provided by [Ulman](https://metrovideogame.fandom.com/wiki/Ulman) at the start of the level.

The VSV makes a return in *[Metro: Last Light](https://metrovideogame.fandom.com/wiki/Metro_Last_Light)* with a few negligible changes to its model and animation.

## Tactics and Use

### Metro 2033

Its low rate of fire and high damage make it perfect for conserving ammunition. As with all primary weapons, the VSK-94 loaded with [MGR](https://metrovideogame.fandom.com/wiki/MGR)s is capable of killing almost anything with a single shot on higher difficulties. Though rapid fire is a viable use for the VSV, it is advised to fire in bursts during close quarter combat, as its 20 round magazine means frequent, albeit quick reloads, and a tendency to rapidly consume through ammo without good trigger discipline. The VSV is a useful weapon while playing Ranger difficulties, all variants of the VSV have a laser sight attached, thus problem of the lack of crosshair can be solved to some extent. The VSV is arguably the second best firearm in Metro 2033. Unlike the [AK-74M](https://metrovideogame.fandom.com/wiki/Kalash_(AK-74M)), however, it is intended for stealth and thus performs poorly in all out firefights. The VSV is also not recommended for engaging groups of mutants at close range.

Fortunately for the player there is only one human opponent in the game armed with this weapon, found in [Black Station](https://metrovideogame.fandom.com/wiki/Black_Station_(Level)).
...
In *Metro: Last Light Redux*, the VSK-94 stays the same as the one in the original version. In *Metro 2033 Redux*, only one enemy uses it, so Artyom has to purchase it from weapon vendors or get it from Ulman in the beginning of [Black Station](https://metrovideogame.fandom.com/wiki/Black_Station_(Metro_2033_Level)). The attachment system is the same as Last Light, meaning that there are more than two variants. Laser sight no longer comes as standard equipment, so the player needs 22 MGR to improve hip-fire accuracy; this is especially useful in Ranger difficulties. The silencer can be removed but this is not advised (even in 2033, unsuppressed VSK-94 is inferior to AK-74M/AK-12 in many ways). The PK-AV optic is no longer available, but Artyom can select lower-magnification optic that works wonders with [night vision](https://metrovideogame.fandom.com/wiki/Night_Vision_Goggles).

## Variants and Customization

VSV has five [attachments](https://metrovideogame.fandom.com/wiki/attachments) in three attachment slots available to it. Its list of attachments is identical to that of the [Kalash 2012](https://metrovideogame.fandom.com/wiki/Kalash_2012).
...
- Can be found on the ice under the bridge in "[The Crossing](https://metrovideogame.fandom.com/wiki/The_Crossing_(Metro_Last_Light_Level))" chapter (no attachments).
- Two can be found on the "[Bridge](https://metrovideogame.fandom.com/wiki/Bridge_(Metro_Last_Light_Level))" chapter. The first one is found under the bridge where you can find a passage, the VSV will have a silencer. While the second one can be found near a dead body (no attachments).
...
- If you wait long enough, Ulman would pass you a suppressed VSV over the grate for you to pick up.
...
- It's implied that the VSK-94 is seeing limited production at [Armory](https://metrovideogame.fandom.com/wiki/Armory_Station_(Location)) and [Polis](https://metrovideogame.fandom.com/wiki/Polis_(Location)) along with the AK-74M.
...
- If left idle, [Artyom](https://metrovideogame.fandom.com/wiki/Artyom) will check the gun's barrel and fittings, genuinely impressed by its fine craftsmanship. The animation is the same for both variants in *Metro 2033*.
...
- In the [Ranger](https://metrovideogame.fandom.com/wiki/Endings) ending, Artyom will have an unscoped VSV as opposed to Enlightened one where he has a [Kalash 2012](https://metrovideogame.fandom.com/wiki/Kalash_2012).
...
- In the original version of *Metro: Last Light* the VSV has a different reload animation compared to the animations found in 2033 and Last Light redux.
...
[de:VSV-Gewehr](https://metrovideogame.fandom.com/wiki/de:VSV-Gewehr)[ru:ВСВ](https://metrovideogame.fandom.com/wiki/ru:ВСВ)[uk:ВСВ](https://metrovideogame.fandom.com/wiki/uk:ВСВ)
