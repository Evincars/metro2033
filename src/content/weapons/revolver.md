...
brief: "The Revolver is a handgun (pistol-caliber carbine with the appropriate attachments) that was created from scrap by th..."
wiki: Revolver
...
- There are multiple **Standard Barrel** for the Revolver that can be found in the Caspian:
  ...
  - One of the fake guards for the "[Baron](https://metrovideogame.fandom.com/wiki/The_False_Baron)" will have a **Standard Barrel** as part of its load-out. Attached to a Revolver.
...
- By adding a stock to the revolver, the revolver in effect becomes a carbine and is similar to several real-life firearms, most notably the [Rossi Circuit Judge](http://www.rossiusa.com/product-list.cfm?category=15).
...
- Strangely, the 'pistol' grip for the revolver has a rudimentary wrapped handle and bolt functioning as a trigger, whilst the standard grip has an actual pistol grip. However, most of the lightest weapon grip are shown to be cut down and skeletonized.
...
- Concept art for the weapon in *Metro Exodus* was created by [Ilya Tolmachev](https://metrovideogame.fandom.com/wiki/Ilya_Tolmachev), which was then turned into in-game models by [Alexander Sitak](https://metrovideogame.fandom.com/wiki/Alexander_Sitak).
- The Revolver had its firing sound completely reworked as of [The Two Colonels](https://metrovideogame.fandom.com/wiki/The_Two_Colonels) update. Each barrel type now has a completely different firing sound, progressively getting louder with longer barrels lengths.
...
- The Sniper Stock attachment has a detailed carving of a [Nosalis](https://metrovideogame.fandom.com/wiki/Nosalis) on it.
