...
brief: "The Lolife (Russian: Подонок) is a high caliber, semi-automatic pistol (machine pistol with the appropriate attachmen..."
wiki: Lolife
...
The Lolife has the most attachments available of any weapon in the game. It has 3 Optics, 2 Barrel upgrades and 4 Misc upgrades. Fully upgrading the weapon turns it from a semi-automatic pistol into a fully-automatic submachine gun with increased ammo capacity, range and accuracy compared to the stock version.

<div class="thumb tright" style="width:350px;">350px<div class="thumbcaption"><center>Lolife variants in *Metro: Last Light*</center></div></div>
...
## Trivia
- The Lolife is called the *Padonak* in the Russian dub, which literally means "Low-Life". It's also inscribed in Cyrillic markings on the receiver (ПАДОНОК). The term can be interpreted as a shiftless or immoral person ("Scumbag") or members of a despised under-class ("Chav", "Ned", or "White Trash").
- The Lolife could get its name from the fact that the weapon is commonly used by bandits and other criminals (a.k.a lowlifes). Despite this, the Lolife is not common in-game and is more expensive than the Revolver or Ashot, making it hard to obtain for someone with little to no MGR.
- The Lolife is based on the Kedr PP-91 (same upper frame and charging handle as the Kedr) and the OTS-02 Kiparis(Handle and barrel), with influences from other pistols such as the Mauser M712 Schnellfeuer.
...
- Though the Lolife is first seen in the hands of a Nazi officer, it's not common among the Nazis.
- The maximum ammunition capacity of pistol rounds does not divide evenly with the magazine size of the Lolife, since the ammo cap is designed around the revolver, which has a fixed 6 round capacity. The regular magazine size of 8 does not divide evenly with the cap of 90, resulting in 11 magazines of 8 and 2 spare rounds (11x8+2). The modified magazine of 20 does not either, resulting in 4 mags of 20 and a half-mag of 10 (4x20+10). .
    - Similarly, the smaller ammunition cap of Ranger mode, 42 rounds, also does not divide evenly with the Lolife. It results in 5 magazines of 8 rounds with two left over (5x8+2), or 2 magazines of 20 rounds with 2 spare rounds (2x20+2).
- The Lolife does not appear in *Metro Exodus*, as its niche of a magazine fed .44 Magnum pistol/submachine gun is taken over by the Bastard, which is chambered for .44 Magnum in that game only.
    - The Stallion pistol introduced in *Sam's Story* fulfils a similar niche in Vladivostok, being a semi-automatic pistol that can be upgraded to full auto, but unlike the Lolife cannot be modified into a carbine.
