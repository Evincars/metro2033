...
const destinations = [
  ...
  { to: '/weapons', code: '11', titleKey: 'nav.weapons', textKey: 'home.dest.weapons' },
  { to: '/ammunition', code: '12', titleKey: 'nav.ammunition', textKey: 'home.dest.ammunition' },
  { to: '/vehicles', code: '13', titleKey: 'nav.vehicles', textKey: 'home.dest.vehicles' },
  { to: '/achievements', code: '14', titleKey: 'nav.achievements', textKey: 'home.dest.achievements' },
  { to: '/endings', code: '15', titleKey: 'nav.endings', textKey: 'home.dest.endings' },
