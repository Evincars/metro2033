...
const destinations = [
  ...
  { to: '/ammunition', code: '12', icon: '🔩', titleKey: 'nav.ammunition', textKey: 'home.dest.ammunition' },
  { to: '/vehicles', code: '13', icon: '🚂', titleKey: 'nav.vehicles', textKey: 'home.dest.vehicles' },
